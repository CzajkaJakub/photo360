...
export class AuthService {
    ...
    authorize(loginCredentials: LoginRequestDto) {
        this.networkService.sendPostRequest<AuthResponseDataDto>(ConnectionConstants.authorizationUrl, loginCredentials, null, null, null)
    ...
    resetUserPassword(resetPasswordRequestDto: ResetPasswordRequestDto) {
        this.networkService.sendPostRequest<RequestResponse>(ConnectionConstants.resetPasswordRequestUrl, resetPasswordRequestDto, null, null, null);
    }

    resetUserPasswordConfirmation(resetPasswordConfirmationRequestDto: ResetPasswordConfirmationRequestDto) {
        this.networkService.sendPostRequest<RequestResponse>(ConnectionConstants.resetPasswordConfirmationUrl, resetPasswordConfirmationRequestDto, null, null, null);
    }

    sendEmailConfirmation() {
        this.networkService.sendGetRequest<RequestResponse>(ConnectionConstants.emailConfirmationRequestUrl, null, null, null);
    }

    confirmUserEmail(userEmailVerificationData: UserEmailVerificationDto) {
        this.networkService.sendGetRequest<RequestResponse>(ConnectionConstants.confirmEmailWithCodeRequestUrl, null, null, [userEmailVerificationData.emailVerificationToken]);
    }
