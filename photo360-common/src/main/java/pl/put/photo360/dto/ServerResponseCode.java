...
public enum ServerResponseCode
{
    ...
    STATUS_PASSWORD_CAN_NOT_BE_THE_SAME("PASSWORD_CAN_NOT_BE_THE_SAME", HttpStatus.NOT_ACCEPTABLE),
    ...
    STATUS_EMAIL_NOT_CONFIRMED("EMAIL_NOT_CONFIRMED", HttpStatus.CONFLICT),
