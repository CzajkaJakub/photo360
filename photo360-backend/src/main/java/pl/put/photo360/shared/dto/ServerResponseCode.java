...
public enum ServerResponseCode
{
    ...
    STATUS_EMAIL_VERIFIED("EMAIL_VERIFIED",HttpStatus.OK),
    ...
    STATUS_EMAIL_ALREADY_VERIFIED("EMAIL_ALREADY_VERIFIED", HttpStatus.NOT_ACCEPTABLE),
    STATUS_EMAIL_VERIFICATION_TOKEN_NOT_VALID("EMAIL_VERIFICATION_TOKEN_NOT_VALID", HttpStatus.NOT_ACCEPTABLE),
    STATUS_EMAIL_VERIFICATION_TOKEN_EXPIRED("EMAIL_VERIFICATION_TOKEN_EXPIRED", HttpStatus.NOT_ACCEPTABLE),
    STATUS_STATUS_USER_EMAIL_NOT_VERIFIED("STATUS_USER_EMAIL_NOT_VERIFIED", HttpStatus.NOT_FOUND),
    STATUS_EMAIL_NOT_CONFIRMED("EMAIL_NOT_CONFIRMED", HttpStatus.NOT_FOUND),
